...
Case in point, [my most recent blog post]({{ site.baseurl }}{% link _posts/2025/03/2025-03-28-innovation-week.md %}).

# The "hard" way
At the end of [_Resurrection_]({{ site.baseurl }}{% link _posts/2025/03/2025-03-28-innovation-week.md %}#resurrection),
just before [_Three years later..._]({{ site.baseurl }}{% link _posts/2025/03/2025-03-28-innovation-week.md %}#three-years-later), there's a code block where I move my newly merged `not-dead/` subdirectory to a `libs/` directory.
